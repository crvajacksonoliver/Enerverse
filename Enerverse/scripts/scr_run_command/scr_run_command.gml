...
else if (ds_list_find_value(system, a) == "0.2")
{// set block metaData
	scr_block_set_meta_data(real(ds_list_find_value(system, a + 1)), real(ds_list_find_value(system, a + 2)), ds_list_find_value(system, a + 3));
	a += 3;
}
else if (ds_list_find_value(system, a) == "0.3")
{// set block metaData char
	scr_block_set_meta_data_char(real(ds_list_find_value(system, a + 1)), real(ds_list_find_value(system, a + 2)), ds_list_find_value(system, a + 3), ds_list_find_value(system, a + 4));
	a += 4;
}
...
else if (ds_list_find_value(system, a) == "1.1")
{// get block
	var gx = real(ds_list_find_value(system, a + 1));
	var gy = real(ds_list_find_value(system, a + 2));
	
	var blockMetaData = array_get(scr_block_get(gx, gy), 1);
	...
	var call = array_get(global.external_calls[modIndex], 7);
	var otherArgs = ds_list_find_value(system, a + 6) + ";" + string(real(ds_list_find_value(system, a + 4))) + ";" + string(real(ds_list_find_value(system, a + 5))) + ";";
	
	//block update
	var unparsed = external_call(call, ds_list_find_value(system, a + 3), blockMetaData, otherArgs);
	scr_run_result(unparsed);
